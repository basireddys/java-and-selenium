...
public class CalenderDateTimePicker {
    ...
    public void testDatePicker() throws Exception{
        ...
        String dateTime ="13/07/2065 1:00 PM";
       ...
       // driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        ...
        driver.findElement(By.xpath("/html/body/div[8]/div[2]/div[4]/div[2]/div/a")).click();
        
       // driver.findElement(By.xpath("//*[@class = 'optanon-allow-all')]//*[test() = 'Accept Cookies']")).click();
        
        Thread.sleep(1000);
        
        //button to open calendar
        
        WebElement selectDate = driver.findElement(By.xpath("//*[@id=\"example\"]/div/span/span/span[2]/span[1]"));
        ...
        WebElement selectTime = driver.findElement(By.xpath("//*[@id=\"example\"]/div/span/span/span[2]/span[2]"));
